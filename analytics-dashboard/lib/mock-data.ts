import type { BuyerStats, SellerStats, PaymentsStats } from "./types";
...
export const mockBuyerStats: BuyerStats = {
  ...
  ultimosPedidos: [
    {
      id: "1",
      compradorId: "u1",
      compradorNombre: "M. Gómez",
      vendedorNombre: "Vivero El Ceibo",
      monto: 7200,
      estado: "entregada",
      creadoEn: "2026-06-13",
    },
    {
      id: "2",
      compradorId: "u2",
      compradorNombre: "L. Fernández",
      vendedorNombre: "Raíces Vivas",
      monto: 3450,
      estado: "listo",
      creadoEn: "2026-06-13",
    },
    ...
    },
    {
      id: "4",
      compradorId: "u4",
      compradorNombre: "C. Martínez",
      vendedorNombre: "Brotes del Sur",
      monto: 2100,
      estado: "pendiente",
      creadoEn: "2026-06-12",
    },
    {
      id: "5",
      compradorId: "u5",
      compradorNombre: "A. López",
      vendedorNombre: "Verde Nativo",
      monto: 5600,
      estado: "entregada",
      creadoEn: "2026-06-11",
    },
  ...
  hilosForo: [
    {
      id: "1",
      titulo: "¿Cuándo regar un pothos en invierno?",
      autor: "L. Fernández",
      respuestas: 34,
      likes: 87,
      creadoEn: "2026-06-08",
    ...
    {
      id: "2",
      titulo: "Mis cactus se ponen amarillos — ayuda",
      autor: "M. Gómez",
      respuestas: 28,
      likes: 64,
      creadoEn: "2026-06-05",
    ...
    {
      id: "3",
      titulo: "Recomendaciones de viveros en Bahía",
      autor: "V. Torres",
      respuestas: 21,
      likes: 52,
      creadoEn: "2026-06-02",
    ...
    {
      id: "4",
      titulo: "Tips para Monstera en departamento",
      autor: "P. Rodríguez",
      respuestas: 19,
      likes: 41,
      creadoEn: "2026-05-28",
    ...
    {
      id: "5",
      titulo: "Tierra para suculentas — ¿perlita sí o no?",
      autor: "C. Martínez",
      respuestas: 16,
      likes: 38,
      creadoEn: "2026-05-21",
...
export const mockSellerStats: SellerStats = {
  ...
  topProductos: [
    ...
    },
    {
      ...
      vendedorNombre: "Cactáceas Finas",
      precio: 3500,
      unidadesVendidas: 97,
      ingresoTotal: 339500,
    },
    ...
    },
    {
      ...
      categoria: "Interior",
      vendedorNombre: "La Selva Urbana",
      precio: 5200,
      unidadesVendidas: 76,
      ingresoTotal: 395200,
    },
